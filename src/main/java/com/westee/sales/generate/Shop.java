...
public class Shop implements Serializable {
     ...
     * @mbg.generated Tue Aug 01 22:05:43 CST 2023
     */
    public Shop(Long id, String name, Float latitude, Float longitude, String description, String imgUrl, Long ownerUserId, String status, Date createdAt, Date updatedAt) {
        this.id = id;
        this.name = name;
